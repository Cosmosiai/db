...
/*В основном здесь представлено создание базы данных 
Я не успел ее заполнить*/
...
select * from tovar t, tip_tovara tt where t.id_tip_postavki = tt.id_tip_postavki and tt.tip_postavki = 'äîïîëíèåòëüíàÿ';

/*â îñíîâíîì çäåñü ñêðèïò ñîçäàíèÿ áàçû è ñåëåêòû. Ïîëíîñòüþ íå óñïåë*/
